...
def main(sc, sqlContext, properties_file, spark_etl_logger):
	...
	if dict_tbl_properties['data_source_type'] == 'sfdc':
		...
		spark_etl_logger.error("Datasource type is not defined. Please define datasource type in table properties config file")
		exit()
